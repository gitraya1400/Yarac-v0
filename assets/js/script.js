...
function checkout() {
  ...
  let message = "🛍️ *Yarac Fashion Store - New Order*\n\n"
  ...
  cart.forEach((item, index) => {
    ...
    message += `   Price: Rp ${formatPrice(item.price * item.quantity)}\n\n`
  })
  ...
  showNotification("Redirecting to WhatsApp for checkout...", "success")
}
